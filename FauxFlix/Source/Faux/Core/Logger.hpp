...
namespace Faux
{
    ...
    // Defines
    ////////////////////////////////////////////////////////////////////////////////////
    #if !defined(FF_CONFIG_DISTRIBUTION)
        #define FF_ASSERT(x, fmt, ...) do { if (!(x)) { ::Faux::Logger::Fatal(fmt __VA_OPT__(,) __VA_ARGS__); NANO_DEBUG_BREAK(); } } while (false)
    #else
        #define FF_ASSERT(x, fmt, ...)
    #endif
